...
class GraphicBank():
    ...
    def getTileImage(self, tileNumber, palette, bankHasPalettes=True):
        assert(self.tileWidth > 0)
        assert(self.tileHeight > 0)
        planarTileData = self.getPlanarTileFromBankData(tileNumber, bankHasPalettes)
    ...
    def getPlanarTileFromBankData(self, tileNumber, hasPalettes=True):
